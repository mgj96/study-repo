...
CATEGORIES=(algorithms languages llm concepts papers cs-fundamentals conventions tradeoffs thinking quizzes github-actions obsidian)
...
desc() {
  case "$1" in
    ...
    languages)      echo "언어 불문 공통 개념과 Java↔C# 관용구 차이·C# 개발 가이드." ;;
