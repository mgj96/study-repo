...
> 🧪 **직접 해보기 →** [IoU vs 경계 정확도 실험실](https://mgj96.github.io/study-repo/labs/iou-vs-boundary.html)
> 털 달린 도형을 원으로 뭉뚱그리면 **J는 90.5%인데 F는 50.8%**가 나온다. 매끈한 도형을 **6픽셀만 밀어도** J는 89.7%를 유지하는데 F는 38.3%로 떨어진다. 허용 오차를 8px로 올리면 그 F가 다시 100%가 된다 — 지표 하나만 보면 안 되는 이유를 손으로 확인할 수 있다.
