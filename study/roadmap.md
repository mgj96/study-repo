...
> **관련 노트**: [ai-ml/](ai-ml/) · [graphics/](graphics/) · [graphics-vs-ml.md](graphics-vs-ml.md) · [lang/java-oop.md](lang/java-oop.md)
...
**개념 순서** (→ [ml-attention-study-note.md](ai-ml/ml-attention-study-note.md) 그대로)
...
- **개념 순서** (→ [graphics-study-note.md](graphics/graphics-study-note.md) 그대로)
...
- [lang/java-oop.md](lang/java-oop.md) — Java의 OOP·상속을 개념·어원·철학으로 정리 (이미 아는 Java를 깊이 이해).
